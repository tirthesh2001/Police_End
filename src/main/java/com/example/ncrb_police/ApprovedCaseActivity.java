                        ...
                        if (status.equals("Approved")){
                            ...
                            approve.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    FirebaseDatabase.getInstance().getReference("Approved Cases").push().setValue(put_data).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                    ...
                                    FirebaseDatabase.getInstance().getReference("FIR Records").push().setValue(put_data).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                Toast.makeText(getApplicationContext(), "Success: Case Approved", Toast.LENGTH_SHORT).show();
